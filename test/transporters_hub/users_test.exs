defmodule TransportersHub.UsersTest do
  use TransportersHub.DataCase

  alias TransportersHub.Users

  describe "users" do
    alias TransportersHub.Users.User

    import TransportersHub.UsersFixtures
